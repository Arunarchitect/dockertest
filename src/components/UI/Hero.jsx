        ...
        <div className="container pt-14">
            <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
                ...
                <div className="w-full md:basis-1/2">
                    ...
                    <a href="#contact">
                        <button className='bg-black text-white font-[500] flex items-center gap-2 hover:bg-smallTextColor ease-in duration-300 py-2 px-4 rounded-[8px]'><i className="ri-mail-line"></i>Contact Me</button>
                    </a>
                    <a href="#portfolio">
                    ...
                    <p data-aos="fade-left" data-aos-duration='1500' className='flex gap-2 text-headingColor mt-14 font-[500] text-[15px] leading-7 sm:pl-14 sm:pr-10'>
                        ...
                        An architect and urban planner. My passion lies in crafting spaces that seamlessly merge functionality, aesthetics, and sustainability. With a keen eye for detail and a commitment to innovative design, I bring a fresh perspective to every architectural project.
                        </p>
